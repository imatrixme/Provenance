...
public let PVAppGroupId = Bundle.main.infoDictionary?["APP_GROUP_IDENTIFIER"] as? String ?? "group.com.matrixme.provenance"
...
public let UbiquityIdentityTokenKey = (Bundle.main.bundleIdentifier ?? "com.matrixme.provenance")  + ".UbiquityIdentityToken"
